...
public class MySceneObject extends SceneObject implements BBox{
	...
	@Override
	public BBox getBBox() {
		MySceneObject future = new MySceneObject();
	...
	public void removeCollisions(){
		for(int i = 0; i < MyScene.futureBBox.size(); ++i){
			while(intersects(MyScene.futureBBox.get(i)) && !(Integer.valueOf(name).equals(i + MyScene.num))){
				backtrack();
